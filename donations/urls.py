...
urlpatterns = [
    ...
    path('donations/<uuid:pk>/save/', SavedDonationView.as_view(), name='save-donation'), # Alternative Create
    path('donations/<uuid:pk>/unsave/', UnsaveDonationView.as_view(), name='unsave-donation'),
